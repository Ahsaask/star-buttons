...
function App() {
  ...
  }, [getStarCenterFromPosition, merging, constellation])
  ...
  const handleUniteAll = () => {
    ...
    // Set constellation to 'all' with fullscreen phase
    setConstellation({
      key: 'all',
    ...
    // Phase 2: Start fading after some time
    setTimeout(() => {
      setConstellation(prev => prev ? { ...prev, phase: 'fading-fullscreen' } : null)
    }, 5000)
      ...
      {constellation && (
        ...
        >
          ...
          {(constellation.phase === 'fullscreen' || constellation.phase === 'fading-fullscreen') && (
            <img
              src={RELATIONSHIP_IMAGES['all']}
              alt="All Stars United"
